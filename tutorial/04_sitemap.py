# ------------------------------------------------------------
# File: tutorial/04_sitemap.py
# Description:
# This Flask application adds a sitemap feature to the Book Library.
# - '/sitemap' generates a hierarchical view of all books, volumes,
#   and chapters in the 'books/' directory.
# - Lists folders and Markdown files automatically, preserving
#   nested structure.
# - Each entry links to its respective Markdown route ('/books/<path:md_path>').
# - Uses Jinja2 template inheritance (base.html) and renders
#   the layout via 'app/sitemap.html'.
# - Dynamic page titles are generated from folder or file names.
# Ideal for quickly navigating all content in the Book Library or
# lyrics viewer project.
# ------------------------------------------------------------
