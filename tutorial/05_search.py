# ------------------------------------------------------------
# File: tutorial/05_search.py
# Description:
# This Flask application adds a search feature to the Book Library.
# - '/search' searches all Markdown files in the 'books/' directory
#   for a given query string.
# - Returns a snippet of the match with a link to the matching file.
# - Uses Jinja2 template inheritance (base.html) and renders
#   the layout via 'app/search.html'.
# - Capitalizes the first letter of the query for display as a tag.
# Ideal for quickly finding chapters, volumes, or specific content
# in your Book Library or lyrics viewer project.
# ------------------------------------------------------------
