# File: tutorial/03_markdown_nested.py
# Description:
# This Flask application builds on previous tutorials by adding full
# nested folder support for Markdown rendering.
# - '/books/<path:md_path>' renders a Markdown file or README.md inside folders.
# - Supports nested folders and automatically converts relative links (./volume-1) to correct Flask routes.
# - Line breaks in Markdown are converted to <br /> for proper display of lyrics or small paragraphs.
# - Uses Jinja2 template inheritance (base.html) for consistent layout.
# - Dynamic page titles are generated from filenames or folder names.
# Ideal for a Book Library, Light Novel, or lyrics viewer with nested directories.
